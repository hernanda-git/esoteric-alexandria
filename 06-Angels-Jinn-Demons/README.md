...
The spirit-world across traditions — the hierarchies, the names, the operations.
...
- → `05-Talismanic-Magick/03-Goetia-Solomonic-Grimoire` — the conjuration tradition
- → `08-Kabbalah-Numerology/01-Gematria-Mapping` — the gematria behind the names
- → `02-Hurufiyya-Lettrism/01-Ilm-al-Huruf-Overview` — the *'azima* (binding) tradition
- → `10-Hermeticism-Gnosticism/01-Corpus-Hermeticum` — the Hermetic spirits
