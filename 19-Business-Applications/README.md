...
The business bridge — the application of esoteric structures to leadership, organization, and strategy.
...
**Removed:** previous bridge drafts `the-leader-as-magus-vision-charisma-action.md` and `the-organization-as-a-subtle-body.md` were older superseded narratives. Canonical docs above replace them.

### Deep-Dive Paths

- `02-Leader-Work-Without-The-Overclaim.md` — best starting point for leadership; grounded in Drucker/Kotter/Kouzes-Posner without esoteric overlay.
- `02-The-Magus-In-The-Western-Esoteric-Tradition.md` — historical magus grade, distinct from modern leader role.
- `03-Org-Culture-As-Culture-Not-Subtle-Body.md` — grounding in Schein/Handy/Hofstede/Cameron-Quinn/Laloux.
- `06-The-Fifth-Discipline-Systemic-Leadership.md` — Senge as real systems reading.

### Cross-References

- [[16-Science-Resonance/01-Resonance-And-Coherence]] — resonance as organizational condition
- [[20-Trading-Risk-Archetypes/01-Risk-As-Initiation]] — discipline as initiation
- [[18-Psychology-Jungian/04-Individuation-Process]] — individuation/leadership maturity
